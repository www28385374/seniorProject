...
const SavedEventScreen = ({navigation}) => {
    // Pull to Refresh
        ...
        setTimeout( async ()=>{
            ...
            fetch('http://192.168.137.51:8080/frontend/show_save_all_data', {
                ...
                return Promise.all([resp.ok, resp.status, resp.json()]);
                    ...
                    console.log([ok,status,json]);
                if (ok) {
                    setnews(result.map((allData, index) => ({
                        ...allData,
                        saveStatus: '1',
                      }))
                    );
                                    ...
                                    <View style={{flex:1,justifyContent:'space-between',flexDirection:'row'}}>
                                        ...
                                        <TouchableRipple onPress={
                                            ...
                                            ()=> {
                                                ...
                                                let eventEndDate = moment(`${info.upload_date} 08`).add(2, 'hours').toISOString()
        ...
        >
            <View style={{marginTop: 0}}>
                <View style={styles.center}>
                    <Text style={{color:'gray'}}>Pull down to Refresh!</Text>
                </View>
                <NewsList news={news} />
            </View>
        </ScrollView>
