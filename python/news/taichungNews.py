...
class GetPageByXpath(BaseFunc):
    ...
    def get_num_page(self, html:object, cmd:str) -> int :
        ...
        num_page=int(re.sub(r'.*age\=|\&.*','',num_page))
        return num_page
...
class GetAllContent(BaseFunc):
    ...
    def merge_page_content(self, html:object) -> bool:
        ...
        for i in range(dict_all_content['num_data']):
            ...
            href="https://www.culture.taichung.gov.tw/"+dict_all_content['all_href'][i]
    ...
    def get_page_all_content(self, html:object) -> dict:
        ...
        """
        num_data=len(html.xpath('//*[@class="list"]//li'))
        all_title=html.xpath('//*[@class="list"]//li//a//@title')
        all_href=html.xpath('//*[@class="list"]//li//a//@href')
        all_date=html.xpath('//*[@class="list"]//a//span[2]/text()')
    ...
    def get_article_content(self, href:str) -> str:
        ...
        try:
            content="".join(html.xpath('//*[@class="cpArticle"]//text()'))
    ...
    def main_function(self):
        ...
        html_home=fn_get_num_page.get_html("https://www.culture.taichung.gov.tw/2061062/2061683/2098053?Page=1&PageSize=30&type=")
        num_page=fn_get_num_page.get_num_page(html_home,'//*[@class="last"]/a/@href')

        fn_merge_page_content=GetAllContent()
        for i in range(num_page):
            html_page=fn_merge_page_content.get_html(f"https://www.culture.taichung.gov.tw/2061062/2061683/2098053?Page={i+1}&PageSize=30&type=")
            result=fn_merge_page_content.merge_page_content(html_page)
            if(result==False):
                break
        list_total=fn_merge_page_content.get_list_total()
        fn_merge_page_content.write_to_json("taichungNews",list_total)
